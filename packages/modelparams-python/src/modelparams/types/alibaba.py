...
Deepseek_V4_1_FlashParams = TypedDict(
...
setattr(Deepseek_V4_1_FlashParams, "__pydantic_config__", _PARAMS_CONFIG)
...
setattr(Glm_5_3_PrimeParams, "__pydantic_config__", _PARAMS_CONFIG)
