...
const PARAM_GROUP_COLORS: Record<string, string> = {
  generation_length: "#BCD1C9",
  sampling: "#CBCADB",
  reasoning: "#eae0ce",
  tooling: "#edd5d5",
  output_format: "#daede1",
  observability: "#edecda",
  provider_metadata: "#dadaed",
};
...
export function paramGroupColor(group: string): string {
  return PARAM_GROUP_COLORS[group] ?? "#e2e8f0";
}
